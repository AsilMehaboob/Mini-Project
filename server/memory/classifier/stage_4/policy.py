...
class PolicyVerdict(Enum):
    PASS      = "pass"
    REJECT    = "reject"
    AMBIGUOUS = "ambiguous"  # Route to Stage 5 for LLM review
...
# ---------------------------------------------------------------------------
# Prohibited patterns → hard REJECT
# Content that is clearly dangerous and must never be stored.
# ---------------------------------------------------------------------------
...
_PROHIBITED: list[re.Pattern] = [
    ...
    # Credential theft / hacking instructions
    re.compile(
...
# ---------------------------------------------------------------------------
# Ambiguous patterns → route to Stage 5 for LLM advisory
# Suspicious but might be legitimate (security research, fiction, etc.).
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Tier-specific minimum content length
# ---------------------------------------------------------------------------
